...
static int RegisterGetBrickletDeployData()
{
  ...
  cmdTemplate = "MFR_GetBrickletDeployData /R=(number:startBrickletID[,number:endBrickletID]) /N=string:baseName "
  ...
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList,
                           sizeof(GetBrickletDeployDataRuntimeParams), (void *) ExecuteGetBrickletDeployData, 0);
}
...
static int RegisterGetResultFileMetaData()
{
  ...
  runtimeStrVarList = S_waveNames;
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList,
                           sizeof(GetResultFileMetaDataRuntimeParams), (void *) ExecuteGetResultFileMetaData, 0);
}
...
static int RegisterGetMtrxFileReaderVersion()
{
  ...
  runtimeStrVarList = "";
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList, sizeof(GetVersionRuntimeParams),
                           (void *) ExecuteGetVersion, 0);
}
...
static int RegisterGetVernissageVersion()
{
  ...
  runtimeStrVarList = "";
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList, sizeof(GetVernissageVersionRuntimeParams),
                           (void *) ExecuteGetVernissageVersion, 0);
}
...
static int RegisterGetXOPErrorMessage()
{
  ...
  runtimeNumVarList = "";
  runtimeStrVarList = "";
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList, sizeof(GetXOPErrorMessageRuntimeParams),
                           (void *) ExecuteGetXOPErrorMessage, 0);
}
...
static int RegisterOpenResultFile()
{
  ...
  runtimeNumVarList = V_flag;
  runtimeStrVarList = "";
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList, sizeof(OpenResultFileRuntimeParams),
                           (void *) ExecuteOpenResultFile, 0);
}
...
static int RegisterCloseResultFile()
{
  ...
  runtimeNumVarList = V_flag;
  runtimeStrVarList = "";
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList, sizeof(CloseResultFileRuntimeParams),
                           (void *) ExecuteCloseResultFile, 0);
}
...
static int RegisterGetBrickletCount()
{
  ...
  runtimeStrVarList = "";
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList, sizeof(GetBrickletCountRuntimeParams),
                           (void *) ExecuteGetBrickletCount, 0);
}
...
static int RegisterGetResultFileName()
{
  ...
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList, sizeof(GetResultFileNameRuntimeParams),
                           (void *) ExecuteGetResultFileName, 0);
}
...
static int RegisterGetBrickletData()
{
  ...
  cmdTemplate = "MFR_GetBrickletData /R=(number:startBrickletID[,number:endBrickletID]) /S=number:pixelSize "
                "/N=string:baseName /DEST=dataFolderRef:dfref";
  runtimeNumVarList = V_flag;
  runtimeStrVarList = S_waveNames;
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList, sizeof(GetBrickletDataRuntimeParams),
                           (void *) ExecuteGetBrickletData, 0);
}
...
static int RegisterGetBrickletMetaData()
{
  ...
  runtimeNumVarList = V_flag;
  runtimeStrVarList = S_waveNames;
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList, sizeof(GetBrickletMetaDataRuntimeParams),
                           (void *) ExecuteGetBrickletMetaData, 0);
}
...
static int RegisterGetBrickletRawData()
{
  ...
  runtimeNumVarList = V_flag;
  runtimeStrVarList = S_waveNames;
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList, sizeof(GetBrickletRawDataRuntimeParams),
                           (void *) ExecuteGetBrickletRawData, 0);
}
...
static int RegisterGetReportTemplate()
{
  ...
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList, sizeof(GetReportTemplateRuntimeParams),
                           (void *) ExecuteGetReportTemplate, 0);
}
...
static int RegisterCreateOverviewTable()
{
  ...
  runtimeNumVarList = V_flag;
  runtimeStrVarList = S_waveNames;
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList, sizeof(CreateOverviewTableRuntimeParams),
                           (void *) ExecuteCreateOverviewTable, 0);
}
...
static int RegisterCheckForNewBricklets()
{
  ...
  runtimeStrVarList = "";
  return RegisterOperation(cmdTemplate, runtimeNumVarList, runtimeStrVarList, sizeof(CheckForNewBrickletsRuntimeParams),
                           (void *) ExecuteCheckForNewBricklets, 0);
}
