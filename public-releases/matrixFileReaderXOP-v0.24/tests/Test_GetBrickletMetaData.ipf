...
#pragma ModuleName=GetBrickletMetaData
...
static Function complains_invalid_range()
	...
	first = -1
	last  = -1
	MFR_GetBrickletMetaData/R=(first, last)
	...
	variable index
	index = -1
	MFR_GetBrickletMetaData/R=(index)
	CHECK_EQUAL_VAR(err.INVALID_RANGE, V_flag)
	CHECK_EMPTY_STR(S_waveNames)
	CHECK_EMPTY_FOLDER()
...
static Function complains_wavename_toolong()
	...
	MFR_GetBrickletMetaData/N="abcdefghijklmnopqrstuvwxyz"
	CHECK_EQUAL_VAR(err.WRONG_PARAMETER, V_flag)
	CHECK_EMPTY_STR(S_waveNames)
	CHECK_EMPTY_FOLDER()
End
...
static Function complains_empty_df()
	...
	dfref df
	MFR_GetBrickletMetaData/DEST=df
	CHECK_EQUAL_VAR(err.WRONG_PARAMETER, V_flag)
	CHECK_EMPTY_STR(S_waveNames)
	CHECK_EMPTY_FOLDER()
End
...
static Function creates_one_wave()
	...
	MFR_OpenResultFile/K folder + file
	CHECK_EQUAL_VAR(err.SUCCESS, V_flag)
	MFR_GetBrickletMetaData/R=(1)
	CHECK_EQUAL_VAR(err.SUCCESS, V_flag)
	CHECK_WAVE($":X_00001:metaData_00001", TEXT_WAVE)
...
static Function creates_one_wave_df_name()
	...
	NewDataFolder abcd
	dfref df = abcd
	MFR_GetBrickletMetaData/DEST=df/N="myWave"/R=(1)
	CHECK_EQUAL_VAR(err.SUCCESS, V_flag)
...
static Function creates_one_wave_free_df()
	...
	MFR_GetBrickletMetaData/DEST=df/R=(1)
	CHECK_EQUAL_VAR(err.SUCCESS, V_flag)
	Wave/SDFR=df wv = $":X_00001:metaData_00001"
	CHECK_WAVE(wv, TEXT_WAVE)
...
static Function creates_waves()
	...
	for(i = 1; i <= numBricklets; i+=1)
		string wvName
		sprintf wvName, "metaData_%05d", i
...
static Function does_not_overwrite_by_default()
	...
	MFR_GetBrickletMetaData/R=(1, 2)
	CHECK_EQUAL_VAR(err.WAVE_EXIST, V_flag)
	CHECK_EMPTY_STR(S_waveNames)
	CHECK(!WaveExists($":X_00002:metaData_00002"))
End
...
static Function setting_datafolder()
	...
	MFR_GetBrickletMetaData/R=(1)
	CHECK_EQUAL_VAR(err.SUCCESS, V_flag)
	CHECK_WAVE($"metaData_00001", TEXT_WAVE)
...
static Function prefers_dfref_settings()
	...
	MFR_GetBrickletMetaData/R=(1)/DEST=dfr
	CHECK_EQUAL_VAR(err.SUCCESS, V_flag)
	Wave/SDFR=dfr wv1 = $":X_00001:metadata_00001"
...
static Function liberal_wave_name_works()
	...
	MFR_GetBrickletMetaData/N="a b"/R=1
	CHECK_EQUAL_VAR(err.SUCCESS, V_flag)
	CHECK_EQUAL_VAR(ItemsInList(S_waveNames), 1)
	CHECK_WAVE($StringFromList(0, S_waveNames), TEXT_WAVE)
End
